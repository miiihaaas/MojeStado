...
class Product(db.Model):
    ...
    product_price_per_unit_farmer = db.Column(db.Float, nullable=False) #! implementirati ovu izmenu u kodu i sql-u
    product_price_per_unit = db.Column(db.Float, nullable=False)
    product_price_per_kg = db.Column(db.Float, nullable=True)
