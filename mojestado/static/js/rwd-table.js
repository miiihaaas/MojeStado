...
(function ($) {
    ...
    ResponsiveTable.prototype.createButtonToolbar = function() {
        ...
        this.$dropdownBtn = $('<button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown">' + this.options.i18n.display + ' <span class="caret"></span></button>');
        ...
        if(this.options.addFocusBtn) {
            ...
            // Create focus btn
            this.$focusBtn = $('<button type="button" class="btn btn-secondary">' + this.options.i18n.focus + '</button>');
        ...
        if(this.options.addDisplayAllBtn) {
            ...
            this.$displayAllBtn = $('<button type="button" class="btn btn-secondary">' + this.options.i18n.displayAll + '</button>');
